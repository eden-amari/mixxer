module.exports = [
"[project]/node_modules/react-player/dist/Preview.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const Preview = ({ src, light, oEmbedUrl, onClickPreview, playIcon, previewTabIndex, previewAriaLabel })=>{
    ...
    const fetchImage = async ({ src: src2, light: light2, oEmbedUrl: oEmbedUrl2 })=>{
        if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].isValidElement(light2)) {
            return;
        }
    ...
    const isElement = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].isValidElement(light);
    const flexCenter = {
        display: "flex",
        alignItems: "center",
    ...
    const defaultPlayIcon = /* @__PURE__ */ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].createElement("div", {
        style: styles.shadow,
...
//# sourceMappingURL=node_modules_react-player_dist_Preview_00ur329.js.map